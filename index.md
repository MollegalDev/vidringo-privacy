...
Vidringo may request access to your contacts.

This access is used to:

* display and search contacts inside the app;
* identify contacts associated with incoming and recent calls;
...
When Vidringo is configured as the device's default phone application, it may request access to the device call log.
...
Users may select video or audio files stored on their device for call customization.
...
Vidringo stores some settings locally on the device, including:

* call customization settings;
* per-contact customization settings;
...
Vidringo uses Google advertising and consent services, including Google Mobile Ads and Google's User Messaging Platform.

These services may process information such as device or advertising identifiers, IP address, general location inferred from the IP address, interactions with advertisements or the application, and diagnostic information.

This information may be used by Google for purposes including advertising, analytics, consent management, fraud prevention and security.
...
Most Vidringo data is stored locally on the user's device.

Users can remove local Vidringo data by clearing the application's storage or uninstalling the application.

Removing individual configurations inside Vidringo may also remove the corresponding locally stored settings.

Data processed independently by third-party services such as Google is subject to those services' own retention and deletion practices.

## 9. Security

Vidringo is designed to minimize unnecessary access to user information. Sensitive Android permissions are requested only when required for the corresponding functionality.

Information handled by third-party Google services may be transmitted securely using mechanisms provided by those services.

## 10. Children's privacy

Vidringo is not specifically designed or directed toward children.

## 11. Changes to this Privacy Policy

This Privacy Policy may be updated when Vidringo's features, data practices, third-party services, or legal requirements change.

The updated version will be published at this same location with a revised "Last updated" date.
...
**MollegalDev@outlook.com**

---

# Política de privacidad de Vidringo
...
Vidringo puede solicitar acceso a tus contactos.

Este acceso se utiliza para:

* mostrar y buscar contactos dentro de la aplicación;
* identificar contactos asociados a llamadas entrantes y recientes;
...
Cuando Vidringo está configurada como aplicación de teléfono predeterminada del dispositivo, puede solicitar acceso al registro de llamadas.
...
Los usuarios pueden seleccionar vídeos o archivos de audio almacenados en su dispositivo para personalizar las llamadas.
...
Vidringo almacena determinadas configuraciones en el dispositivo, incluyendo:

* ajustes de personalización de llamadas;
* configuraciones por contacto;
* configuración del Modo descanso;
...
## 6. Publicidad y servicios de terceros

Vidringo utiliza servicios de publicidad y consentimiento de Google, incluyendo Google Mobile Ads y User Messaging Platform.

Estos servicios pueden procesar información como identificadores del dispositivo o publicitarios, dirección IP, ubicación general estimada a partir de la dirección IP, interacciones con anuncios o con la aplicación e información de diagnóstico.

Google puede utilizar esta información con fines que incluyen publicidad, análisis, gestión del consentimiento, prevención del fraude y seguridad.
...
La mayoría de los datos de Vidringo se almacenan localmente en el dispositivo.

El usuario puede eliminar los datos locales de Vidringo borrando el almacenamiento de la aplicación o desinstalándola.

La eliminación de configuraciones individuales dentro de Vidringo también puede eliminar los ajustes locales correspondientes.

Los datos procesados independientemente por servicios de terceros como Google están sujetos a sus propias prácticas de conservación y eliminación.

## 9. Seguridad

Vidringo está diseñada para minimizar el acceso innecesario a información del usuario. Los permisos sensibles de Android se solicitan únicamente cuando son necesarios para la función correspondiente.

La información gestionada por servicios de Google puede transmitirse de forma segura mediante los mecanismos proporcionados por dichos servicios.

## 10. Privacidad de menores

Vidringo no está diseñada ni dirigida específicamente a menores.

## 11. Cambios en esta Política de privacidad

Esta Política de privacidad podrá actualizarse cuando cambien las funciones de Vidringo, sus prácticas de tratamiento de datos, los servicios de terceros utilizados o los requisitos legales.

La versión actualizada se publicará en esta misma ubicación indicando una nueva fecha de última actualización.
